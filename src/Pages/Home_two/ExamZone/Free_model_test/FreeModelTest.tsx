...
import { FreeModel } from "../../../../types/types";
import JobExpart from "../../../../components/JobExpart/JobExpart";
const FreeModelTest = () => {
  const [data, setData] = useState<FreeModel[]>([]);
  useEffect(() => {
    fetch("free-model-test.json")
      .then((res) => res.json())
        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mx-auto">
              ...
              <button className="bg-primary text-[#FFFFFF] flex justify-center items-center py-3 gap-2 px-20 rounded-lg">
                {item.button}
              </button>
            </div>
          </div>
